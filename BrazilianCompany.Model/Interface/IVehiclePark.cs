...
namespace BrazilianCompany.Model.Interface
{
    public interface IVehiclePark
    {
        ...
        /// has two sectors), the system prints "There is no sector <sector> in the park".
        /// If the place does not exist(for example, searching for the tenth place of a parking lot which only
        /// has two places per sector), the system prints "There is no place <place> in sector <sector>"
        /// If there is already a parked vehicle in the place, the system prints "The place (<sector>,<place>)
        /// is occupied".
        /// If there is already a vehicle with the provided license plate in the park, the system prints "There
        /// is already a vehicle with license plate<license_plate> in the park". The license plate number is
